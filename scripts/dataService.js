...
.service('dataService', function(){ //a service is a constructor function!
...
this.getAvengers = function () {
  ...
  for (var prop in teamAvengers){
  	newAvengers.push({name: teamAvengers[prop].name,
...
// In the service, you loop through the array and then send
// it to the control. It's where you filter data
// this is called business logic

// what is an angular service?
// Singleton
// means they're only invoked once.
